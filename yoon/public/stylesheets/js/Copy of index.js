...
$(function(){
	...
	$('.delete').click(function() {
		...
		console.log(deleterUid+ "dpid");
		 $.post('http://192.168.0.160:8080/json/collabo/deleteCollabo.do' /* URL */
...
$('.create').click(
		function() {
			...
			if(prom==''){
			  ...
			  $.post('http://192.168.0.160:8080/json/project/addProject.do' /* URL */
				      , { /* 서버에 보낼 데이터를 객체에 담아 넘긴다 */
				        pname : prom,       
				        pdate : str,
				        uid : uid
  ...
  function loadProjectList(uid) {
  	console.log("aa",uid);
  	$.getJSON('http://192.168.0.160:8080/json/collabo/listCollabo.do?uid=' + uid, 
  	    function(data){
