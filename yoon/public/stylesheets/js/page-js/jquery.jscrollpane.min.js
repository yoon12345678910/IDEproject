...
(function(b, a, c) {
	b.fn.jScrollPane = function(e) {
		function d(D, O) {
			...
			function aG() {
				if (aA) {
					am.append(b('<div class="jspVerticalBar" />').append(
					...
					av = aq.find(">.jspDrag");
					if (az.showArrows) {
						ar = b('<a class="jspArrow jspArrowUp" />').bind("mousedown.jsp",
								aE(0, -1)).bind("click.jsp", aC);
						af = b('<a class="jspArrow jspArrowDown" />').bind("mousedown.jsp",
								aE(0, 1)).bind("click.jsp", aC);
			...
			function z() {
				if (aF) {
					am.append(b('<div class="jspHorizontalBar" />').append(
					...
					h = G.find(">.jspDrag");
					if (az.showArrows) {
						ay = b('<a class="jspArrow jspArrowLeft" />').bind("mousedown.jsp",
								aE(-1, 0)).bind("click.jsp", aC);
						x = b('<a class="jspArrow jspArrowRight" />').bind("mousedown.jsp",
								aE(1, 0)).bind("click.jsp", aC);
						if (az.arrowScrollOnHover) {
									...
									function(aO) {
										if (aO.originalTarget === c
											...
											var aM = b(this), aP = aM.offset(), aN = aO.pageY
												...
												var aS = aM.offset(), aT = aO.pageY - aS.top - A / 2, aQ = v
														* az.scrollPagePercent, aR = i * aQ / (Z - v);
												if (aN < 0) {
													if (I - aR > aT) {
														Q.scrollByY(-aQ)
													} else {
									...
									function(aO) {
										if (aO.originalTarget === c
											...
											var aM = b(this), aP = aM.offset(), aN = aO.pageX
												...
												var aS = aM.offset(), aT = aO.pageX - aS.left - au / 2, aQ = ak
														* az.scrollPagePercent, aR = j * aQ / (T - ak);
												if (aN < 0) {
													if (aa - aR > aT) {
														Q.scrollByX(-aQ)
													} else {
			...
			function S() {
				...
				D.attr("tabindex", 0).unbind("keydown.jsp keypress.jsp").bind(
						"keydown.jsp",
						function(aO) {
							if (aO.target !== this
