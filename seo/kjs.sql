...
CREATE TABLE PROJECTS (
	PID   INTEGER      NOT NULL COMMENT '프로젝트일련번호', -- 프로젝트일련번호
...
ALTER TABLE PROJECTS
	MODIFY COLUMN PID INTEGER NOT NULL AUTO_INCREMENT COMMENT '프로젝트일련번호';
...
CREATE TABLE USERS (
	...
	PTNAME VARCHAR(255) NULL     COMMENT '사진이름', -- 사진이름
	PURL   VARCHAR(255) NULL     COMMENT '사진경로' -- 사진경로
)
COMMENT 'MEMBERS';
